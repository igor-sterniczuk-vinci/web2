...
router.post('/', (req, res) => {
  ...
  if (!title || !link || !duration || !budget) return res.json('Bad request'); // bad practise (will be improved in exercise 1.5) //verification de toutes les variables, si une des variables nest pas bonne on renvoie erreur 400
